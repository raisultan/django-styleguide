...
- бизнес-логика моделях (концепция "Fat models, thin views")
...
- в нашем варианте, грань между сервисами и селекторами стирается, так как сервисы и селекторы, по сути, являются композитными частями элемента бизнес-логики. Мы называем эти элементы сервисами
- каждый сервис хранится в соответствующем неймспейсе, на деле это класс - контейнер
